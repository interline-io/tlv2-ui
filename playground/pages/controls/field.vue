  ...
  <div class="container">
    <section class="section">
      ...
      <div class="content">
        ...
        <!-- Grouped Fields (Addons) -->
        <h2 class="title is-3">
          Grouped Fields (Addons)
        </h2>
        <div class="box">
          <t-field label="URL:" grouped>

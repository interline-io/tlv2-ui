          ...
          <div v-for="(report, reportId) in reports" :key="reportId">
            <tl-link
              ...
              :to="{
                ...
                query: ['apps-transfers-stationKey-maps', 'apps-transfers-stationKey-routes'].includes(reportId) ? queryParamsWithoutTripFilters : route.query,
              }"
...
const reports: Record<string, Report> = {
  'apps-transfers-stationKey-maps': { name: 'Maps & Platforms', disabled: false },

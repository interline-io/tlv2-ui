<template>
  <div>
    <div class="buttons">
      <a class="button is-outlined" :class="errorCount.stops > 0 ? 'is-danger' : 'is-link'" @click="openStops = true">
        <i v-if="errorCount.stops > 0" class="mdi mdi-alert has-text-danger" /> Stops
      </a>

      <a class="button is-outlined" :class="errorCount.pathways > 0 ? 'is-danger' : 'is-link'" @click="openPathways = true">
        <i v-if="errorCount.pathways > 0" class="mdi mdi-alert has-text-danger" /> Pathways
      </a>

      <a class="button is-outlined" :class="stopPathErrorCount > 0 ? 'is-danger' : 'is-link'" @click="openPaths = true">

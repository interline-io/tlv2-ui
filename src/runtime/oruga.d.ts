// Oruga UI component type declarations
// These are copied from @oruga-ui/oruga-next/volar.d.ts but made compatible with tsc
// The /// <reference types> directive doesn't work for command-line TypeScript compilation

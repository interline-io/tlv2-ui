          ...
          <div v-for="(report, reportId) in reports" :key="reportId">
            <tl-link
              ...
              :to="{
                ...
                query: ['transitTransfers-stationKey-maps', 'transitTransfers-stationKey-routes'].includes(reportId) ? queryParamsWithoutTripFilters : route.query,
              }"
...
const reports: Record<string, Report> = {
  'transitTransfers-stationKey-maps': { name: 'Maps & Platforms', disabled: false },
  'transitTransfers-stationKey-routes': { name: 'Routes', disabled: false },
  'transitTransfers-stationKey-transfers': { name: 'Transfers — Individual', disabled: false },
  'transitTransfers-stationKey-transfersummary': { name: 'Transfers - Summary', disabled: false },
  'transitTransfers-stationKey-transferscomparison': { name: 'Transfers - Overview of Different Service Conditions', disabled: true }
}
// ...existing code...

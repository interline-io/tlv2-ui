  ...
  <div v-if="station">
    ...
    <div v-if="ready" class="columns">
      <div class="column is-narrow">
        <div class="block tl-stationEditor-info">
          <o-field label="Station Validation Reports">
            <tl-stationEditor-station-validator
              :station="station"
          ...
          <tl-msg-card v-else-if="selectMode === 'add-pathway'">
            ...
            <div>
              <tl-stationEditor-pathway-editor
                :station="station"
                :value="newPathway()"
                @select-stop="selectStop"
          ...
          <template v-else-if="selectMode === 'find-route'">
            <tl-msg-card v-if="selectedStops.length > 1">
              ...
              <tl-stationEditor-path-viewer :path="selectedPath" />
            </tl-msg-card>
          </template>

            ...
            <section class="modal-card-body">
              ...
              <template v-if="sha1 === latestFeedVersionSha1">
                ...
                <a :href="`https://demo.transit.land/api/v2/rest/feed_versions/${sha1}/download`" target="_blank">
                  ...
                  <p>
                    Older feed versions can be accessed with a <a href="https://www.interline.io/transitland/plans-pricing/" target="_blank">Transitland Hobbyist/Academic, Professional, and Enterprise plan</a>.</p>
